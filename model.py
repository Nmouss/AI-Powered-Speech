...
sentences = sentences[:100] # I AM JUST MODIFYING THIS JUST SO I CAN TEST
...
# Train the model
model.fit(input_data, output_data, epochs=20, batch_size=128, validation_split=0.2)



model.save("next_token_predictor")
